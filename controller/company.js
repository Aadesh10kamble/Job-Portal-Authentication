...
exports.createCompany = async (req, res) => {
    try {
        ...
        const dbResponse = await query(`INSERT INTO company (company_name) VALUES ('${companyName}') RETURNING *`);
        ...
        if (req.file) {
            ...
            const updatedResponse = await query(`UPDATE company SET image_key='${key}' WHERE id='${companyId}' RETURNING *`);
